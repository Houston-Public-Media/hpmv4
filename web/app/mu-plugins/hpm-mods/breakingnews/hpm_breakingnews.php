                            ...
                            <div class="postbox">
                                ...
                                <div class="inside">
                                    <table class="wp-list-table widefat fixed striped posts">
                                        ...
                                        foreach ( $brekingnews['homepage'] as $kp => $vp ) {
                                            ...
                                            <td>
                                                ...
                                                <select id="hpm_breakingnews-homepage-<?php echo $kp; ?>" class="hpm_breakingnews-select homepage-select">
                                                    <option value=""></option>
                                                    <?php
                                            ...
                                            <td>
                                                <select id="hpm_breakingnews-expirationdate-<?php echo $kp; ?>" class="hpm_breakingnews-expirationdate-select expirationdate-select">
                                                    <option value=""></option>
                                                    <option value="1" <?php selected( $brekingnews['expirationdate'][$kp] , 1, TRUE ); ?>>1 Hour</option>
                                                    <option value="2" <?php selected( $brekingnews['expirationdate'][$kp] , 2, TRUE ); ?>>2 Hours</option>
                                                    <option value="3" <?php selected( $brekingnews['expirationdate'][$kp] , 3, TRUE ); ?>>3 Hours</option>
                                                    <option value="4" <?php selected( $brekingnews['expirationdate'][$kp] , 4, TRUE ); ?>>4 Hours</option>
                                                    <option value="5" <?php selected( $brekingnews['expirationdate'][$kp] , 5, TRUE ); ?>>5 Hours</option>
                                                    <option value="6" <?php selected( $brekingnews['expirationdate'][$kp] , 6, TRUE ); ?>>6 Hours</option>
                                                    <option value="7" <?php selected( $brekingnews['expirationdate'][$kp] , 7, TRUE ); ?>>7 Hours</option>
                                                    <option value="8" <?php selected( $brekingnews['expirationdate'][$kp] , 8, TRUE ); ?>>8 Hours</option>
                                                    <option value="9" <?php selected( $brekingnews['expirationdate'][$kp] , 9, TRUE ); ?>>9 Hours</option>
                                                    <option value="10" <?php selected( $brekingnews['expirationdate'][$kp] , 10, TRUE ); ?>>10 Hours</option>
                                                    <option value="11" <?php selected( $brekingnews['expirationdate'][$kp] , 11, TRUE ); ?>>11 Hours</option>
                                                    <option value="12" <?php selected( $brekingnews['expirationdate'][$kp] , 12, TRUE ); ?>>12 Hours</option>
                                                    <option value="13" <?php selected( $brekingnews['expirationdate'][$kp] , 13, TRUE ); ?>>13 Hours</option>
                                                    <option value="14" <?php selected( $brekingnews['expirationdate'][$kp] , 14, TRUE ); ?>>14 Hours</option>
                                                    <option value="15" <?php selected( $brekingnews['expirationdate'][$kp] , 15, TRUE ); ?>>15 Hours</option>
                                                    <option value="16" <?php selected( $brekingnews['expirationdate'][$kp] , 16, TRUE ); ?>>16 Hours</option>
                                                    <option value="17" <?php selected( $brekingnews['expirationdate'][$kp] , 17, TRUE ); ?>>17 Hours</option>
                                                    <option value="18" <?php selected( $brekingnews['expirationdate'][$kp] , 18, TRUE ); ?>>18 Hours</option>
                                                    <option value="19" <?php selected( $brekingnews['expirationdate'][$kp] , 19, TRUE ); ?>>19 Hours</option>
                                                    <option value="20" <?php selected( $brekingnews['expirationdate'][$kp] , 20, TRUE ); ?>>20 Hours</option>
                                                    <option value="21" <?php selected( $brekingnews['expirationdate'][$kp] , 21, TRUE ); ?>>21 Hours</option>
                                                    <option value="22" <?php selected( $brekingnews['expirationdate'][$kp] , 22, TRUE ); ?>>22 Hours</option>
                                                    <option value="23" <?php selected( $brekingnews['expirationdate'][$kp] , 23, TRUE ); ?>>23 Hours</option>
                                                    <option value="24" <?php selected( $brekingnews['expirationdate'][$kp] , 24, TRUE ); ?>>24 Hours</option>
                                    ...
                                    <p>
                                        ...
                                        <!--<label for="hpm_breakingnews[number]"><?php /*_e('Number of slots: ', 'hpmv4' ); */?></label>--><input type="hidden" required="required" name="hpm_breakingnews[number]" id="homepage-number" class="homepage-select-input" value="<?php echo ( !empty( $brekingnews['number'] ) ? $brekingnews['number'] : count( $brekingnews['homepage'] ) ); ?>" style="width: 150px;" /></p>
