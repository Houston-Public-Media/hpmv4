                                    ...
                                    <table class="wp-list-table widefat fixed striped posts">
                                        ...
                                        foreach ( $modules['homepage'] as $kp => $vp ) {
                                            ...
                                            <td>
                                                ...
                                                <select id="hpm_modules-homepage-<?php echo $kp; ?>" class="hpm-modules-select homepage-select">
                                                    <option value=""></option>
                                                    <?php
                                                ...
                                                <input type="hidden" name="hpm_modules[homepage][<?php echo $kp; ?>]" id="homepage-<?php echo $kp; ?>" class="homepage-select-input" value="<?php echo $vp; ?>" style="max-width: 100%;" />
                                                <?php //wp_dropdown_categories(array('hide_empty' => 1, 'orderby' => 'name', 'order' =>'ASC')); ?>
                                            </td>
                                            </tr>
                                            <?php
                                        } ?>
        ...
        <script>
            jQuery(document).ready(function($){
                ...
                $( "#homepage-number" ).keyup(function(){
                    ...
                    let inputVal = $(this).val();
                    $('#hpm_modules-' + inputId).val(inputVal);
                    if ( inputVal !== '' ) {
