...
class BetterImageCreditsWidget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct( 'better-image-credits-widget', __( 'Image Credits', 'better-image-credits' ), [ 'description' => __( 'A widget displaying the image credits', 'better-image-credits' ) ] );
	}
