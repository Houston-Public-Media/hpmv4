...
<xsl:stylesheet version="1.0" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="rss/channel">
		...
		<div id="header">
			<p>This is an RSS Sitemap which helps search engines find all your pages.<br />This is useful for feed aggregators, search engines and spiders that do not support the XML Sitemap format.</p>
		</div>
		<table cellspacing="0">
			<tr>
