...
<xsl:stylesheet version="1.0" xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:sitemapindex="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:image="http://www.google.com/schemas/sitemap-image/1.1" xmlns:news="http://www.google.com/schemas/sitemap-news/0.9">
	...
	<xsl:template match="sitemap:urlset">
		...
		<div id="header">
			<p>This is an XML News Sitemap compatible with major search engines such as Google, Bing, Baidu and Yandex.<br />You can find more information about XML sitemaps on <a href="https://sitemaps.org">sitemaps.org</a></p>
		</div>
		<table cellspacing="0">
			<tr>
