...
class DataAccess {
	static function execute( $cmd ): array|object|null {
		global $wpdb;
	...
	public static function createMetaTable(): void {
		global $wpdb;
	...
	public static function getMetaItem( $id, $type ): array|MetaSettings|\stdClass {
		global $wpdb;
		$tablemeta = $wpdb->prefix . 'xsg_sitemap_meta';
		$cmd = " SELECT * FROM {$tablemeta} WHERE itemId = %d AND itemType = %s ";
	...
	public static function saveMetaItem( $metaItem ): void {
		global $wpdb;
		$tablemeta = $wpdb->prefix . 'xsg_sitemap_meta';
	...
	public static function getLastModified( $date = "updated" ): ?string {
		global $wpdb;
