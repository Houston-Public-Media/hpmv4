...
class NewsProvider extends ProviderCore implements ISitemapProvider {
	...
	public function getPage( $type, $page ): array {
		...
		$cmdWhere =	"WHERE (posts.post_status = 'publish') AND (posts.post_type = 'post') AND posts.post_date > (NOW() - INTERVAL 48 HOUR) AND posts.post_password = '' ";
		...
		$cmd .=	" ORDER BY posts.post_date DESC LIMIT 1000 ";
