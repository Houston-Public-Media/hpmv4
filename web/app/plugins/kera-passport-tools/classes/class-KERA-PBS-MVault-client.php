...
class KERA_PBS_MVault_Client {
	...
	public function create_or_update_membership( $membership_id, $last_name, $first_name, $start_date, $expire_date, $offer, $email = null, $provisional = null, $status = null, $additional_metadata = [] ) {
		$memberinfo = [
			"last_name" => $last_name, 
