...
class PBS_Media_Manager_API_Client {
	...
	*/
	public function __construct( $client_id = '', $client_secret = '', $base_endpoint = '' ) {
		...
		$this->passport_windows = [
			'public',
			'all_members',
			'station_members',
			'unavailable'
		];
		$this->asset_types = [ 'preview', 'clip', 'extra' ];
		$this->episode_asset_types = [
			'preview',
			'clip',
			'extra',
			'full_length'
	...
	*/
	 ...
	 */
	public function create_child( $parent_id, $parent_type, $type, $attribs = [] ) {
		...
		curl_setopt( $ch, CURLOPT_HTTPHEADER, [ 'Content-Type: application/json', 'Content-Length: ' . strlen( $payload_json ) ] );
		$result = curl_exec( $ch );
		$info = curl_getinfo( $ch );
		$errors = curl_error( $ch );
		curl_close( $ch );
		if ( !in_array( $info['http_code'], [ 200, 201, 202, 204 ] ) ) :
			$result = $this->make_response_array( $result );
			return [
				'errors' => [
					'info' => $info,
	 ...
	 */
	public function update_object( $id, $type, $attribs = [] ) {
	 ...
	 *		The items.
	 */
	public function get_item_of_type( $id, $type, $private = FALSE, $queryargs = [] ) {
		$endpoint = "/" . $type . "s/" . $id . "/";
	 ...
	 */
	public function get_list_data( $endpoint, $args = [], $include_metadata = FALSE) {
	 ...
	 *	 An array of items.
	 */
	public function get_child_items_of_type( $parent_id, $parent_type, $type, $queryargs = [], $include_metadata = FALSE) {
	 ...
	 */
	public function get_child_assets( $parent_id, $parent_type = 'episode', $asset_type = 'all', $window = 'all', $queryargs = [] ) {
	 ...
	 *	 Returns the asset.
	 */
	public function get_asset( $id, $private = FALSE, $queryargs = [] ) {
	 ...
	 *	 Returns the episode.
	 */
	public function get_episode( $id, $queryargs = [] ) {
	 ...
	 *	 Returns the special.
	 */
	public function get_special( $id, $queryargs = [] ) {
	 ...
	 */
	public function get_collection($id, $queryargs = [] ) {
	 ...
	 *	 Returns the season.
	 */
	public function get_season($id, $queryargs = [] ) {
	 ...
	 *	 Returns the show.
	 */
	public function get_show( $id, $queryargs = [] ) {
	 ...
	 *	 Returns the asset.
	 */
	public function get_remote_asset( $id, $queryargs = [] ) {
	 ...
	 *	 Returns the asset.
	 */
	public function get_franchise( $id, $queryargs = [] ) {
	 ...
	 *	 Returns the station.
	 */
	public function get_station( $id, $queryargs = [] ) {
	 ...
	 */
	public function get_franchises( $queryargs = [] ) {
		$query = "/franchises/";
	 ...
	 */
	public function get_shows( $queryargs = [] ) {
		$query = "/shows/";
		return $this->get_list_data( $query, $queryargs );
	}
	 ...
	 */
	public function get_assets( $queryargs = [] ) {
		$query = "/assets/";
		return $this->get_list_data( $query, $queryargs );
	}
	 ...
	 *	 Returns a list of shows.
	 */
	public function get_franchise_shows( $franchise_id, $queryargs = [] ) {
	 ...
	 */
	public function get_show_seasons( $show_id, $queryargs = [] ) {
	 ...
	 */
	public function get_show_specials( $show_id, $queryargs = [] ) {
	 ...
	 */
	public function get_season_episodes( $season_id, $queryargs = [] ) {
	 ...
	 *	 Returns a list of assets.
	 */
	public function get_episode_assets( $episode_id, $asset_type = 'all', $window = 'all', $queryargs = [] ) {
	 ...
	 */
	public function get_special_assets( $special_id, $asset_type = 'all', $window = 'all', $queryargs = [] ) {
	 ...
	 */
	public function get_season_assets( $season_id, $asset_type = 'all', $window = 'all', $queryargs = [] ) {
	 ...
	 */
	public function get_show_assets( $show_id, $asset_type = 'all', $window = 'all', $queryargs = [] ) {
	 ...
	 */
	public function get_franchise_assets( $franchise_id, $asset_type = 'all', $window = 'all', $queryargs = [] ) {
