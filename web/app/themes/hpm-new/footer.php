					...
					<div class="foot-contact">
						...
						<div id="footer-social">
							<div class="footer-social-icon">
								<a href="https://www.facebook.com/houstonpublicmedia" target="_blank" style="background-color: rgb(59,89,152);"><span class="fab fa-facebook-f" aria-hidden="true"></span></a>
							</div>
							<div class="footer-social-icon">
								<a href="https://twitter.com/houstonpubmedia" target="_blank" style="background-color: rgb(29,161,242);"><span class="fab fa-twitter" aria-hidden="true"></span></a>
							</div>
							<div class="footer-social-icon">
								<a href="https://instagram.com/houstonpubmedia" target="_blank" style="background-color: rgb(138,58,185);"><span class="fab fa-instagram" aria-hidden="true"></span></a>
							</div>
							<div class="footer-social-icon">
								<a href="https://www.youtube.com/user/houstonpublicmedia" target="_blank" style="background-color: rgb(234,50,35);"><span class="fab fa-youtube" aria-hidden="true"></span></a>
							</div>
							<div class="footer-social-icon">
								<a href="https://linkedin.com/company/houstonpublicmedia" target="_blank" style="background-color: rgb(40,103,178);"><span class="fab fa-linkedin-in" aria-hidden="true"></span></a>
							</div>
						</div>
					</div>
				</section>
