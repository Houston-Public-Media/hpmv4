...
/* add_action( 'wp_head', function() {
	if ( $_SERVER['HTTP_X_ORIGINAL_HOST'] !== 'jcounts.ngrok.io' && !is_admin() ) :
		...
		wp_enqueue_script( 'hpm-jpp', get_template_directory_uri().'/js/experiments/jppTurbo.js', [ 'hpm-plyr' ], date('Y-m-d-H') );
	...
	if ( $_SERVER['HTTP_X_ORIGINAL_HOST'] !== 'jcounts.ngrok.io' && !is_admin() ) : ?>
		<div id="jpp-player-persist" data-turbo-permanent>
			...
			<div id="jpp-button-wrap">
				<button id="jpp-button-menu"><?php echo hpm_svg_output( 'bars' ); ?></button>
			</div>
