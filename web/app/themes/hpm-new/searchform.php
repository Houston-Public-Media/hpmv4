<form role="search" method="get" class="search-form" action="/search/">
	...
	<button aria-label="Submit Search" class="search-submit screen-reader-text"><?php echo hpm_svg_output( 'search' ); ?><span class="screen-reader-text">Search</span></button>
</form>