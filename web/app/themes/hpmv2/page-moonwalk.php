...
<?php endforeach; ?>
							...
							<section id="moon-behind">
								...
								<h2><em>Moonwalk</em> Special Broadcasts Premiere</h2>
								<div class="other-way">
									<h3>Monday | July 8 at 10pm | <span>TV 8</span></h3>
									<h3>Saturday | July 20 at 5pm | <span>News 88.7</span></h3>
									<h3><img src="https://cdn.hpm.io/assets/images/pbs_app_icon2x.png" alt="PBS App logo" /><span>Available on demand beginning July 8 on the PBS App</span></h3>
								</div>
							</section>
						</div><!-- .entry-content -->
					</main><!-- .site-main -->
