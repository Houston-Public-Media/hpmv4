        ...
        <main id="main" class="site-main" role="main">
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry-content">
					...
					<?php
						$uri_title = rawurlencode( $headline );
						$uri_link = rawurlencode( 'http://www.houstonpublicmedia.org/npr/'.date( 'Y/m/d/',$date_offset).$id.'/'.sanitize_title( $headline ).'/' );
						$uri_excerpt = rawurlencode( $subheading ); ?>
						<h4>Share</h4>
						...
						<div class="article-share-icon">
							<a href="mailto:?subject=Someone%20Shared%20an%20Article%20From%20Houston%20Public%20Media%21&body=I%20would%20like%20to%20share%20an%20article%20I%20found%20on%20Houston%20Public%20Media!%0A%0A<?php echo $headline; ?>%0A%0A<?php echo $uri_link; ?>">
