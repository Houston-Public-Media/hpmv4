...
<?php
	...
	<div class="card-content">
		<header class="entry-header">
			...
			<div class="icon-wrap">
			<?php
				echo ( !empty( $staff['phone'] ) ? '<div class="service-icon phone"><a href="tel://+1' . str_replace( [ '(', ')', ' ', '-', '.' ], [ '', '', '', '', '' ], $staff['phone'] ) . '" title="Call ' . get_the_title() . ' at ' . $staff['phone'] . '" data-phone="' . $staff['phone'] . '">' . hpm_svg_output( 'phone' ) . '<span class="screen-reader-text" >Call</span></a></div>' : '' );
				...
				echo ( !empty( $staff['linkedin'] ) ? '<div class="service-icon linkedin"><a href="' . $staff['linkedin'] .'" target="_blank">' . hpm_svg_output( 'linkedin' ) . '<span class="screen-reader-text" >Linkedln</span></a></div>' : '' );
				echo ( !empty( $staff['email'] ) ? '<div class="service-icon envelope"><a href="mailto:' . $staff['email'] . '" target="_blank">' . hpm_svg_output( 'envelope' ) . '<span class="screen-reader-text" >Email</span></a></div>' : '' ); ?>
			</div>
		</header>
