...
function hpm_talkshows(): string {
	...
	if ( !in_array( 135762, $anc ) && !in_array( get_the_ID(), $bans ) && !empty( $wp_query->post ) && $wp_query->post->post_type !== 'embeds' ) {
		if ( ( $now['wday'] > 0 && $now['wday'] < 6 ) && ( $now['hours'] == 9 ) && !empty( $hm_air[ $now['hours'] ] ) && $hm_air[ $now['hours'] ] ) {
			...
			$output .= '<div id="hm-top" class="election"><p><span><a href="/listen-live/"><strong>Houston Election 2024</strong> is on the air now!</a> Join the conversation:</span> Call <a href="tel://+17134408870">713.440.8870</a> | <a href="/listen-live/">Listen Live</a></p></div>';
		}
	}
	return $output;
}
