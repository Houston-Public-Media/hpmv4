            ...
            <nav id="site-navigation" class="main-navigation" role="navigation">
                ...
                <div class="quick-access">
                    ...
                    <ul>
                        ...
                        <li class="nav-top nav-uh"><a target="_blank" href="https://www.uh.edu" rel="noopener" tabindex="0">UH</a></li>
                    </ul>
...
function hpm_breaking_banner(): string {
    ...
    if ( !empty( $hpm_breakingnews['homepage'] ) ) {
        ...
        $date = date('U', $publish+$hpm_breakingnews['expirationdate'][0]*3600);
