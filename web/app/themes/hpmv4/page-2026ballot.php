        ...
        foreach ($county_json['propositions'] as $prop) {
            $flat[] = [
                ...
                'candidacies' => array_map(function($o) {
                    return ['name'=>$o['option'],'party'=>'','is_incumbent'=>false];
                }, $prop['options'] ?? [])
            ];
        }
    }
                            ...
                            foreach ($races as $race) :
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <ul class="list-group">
                                                    <?php foreach ($democrats as $c) : ?>
                                                        <li class="list-group-item DEM<?php echo !empty($c['is_incumbent']) ? ' Incumbent' : ''; ?>">
                                        ...
                                        <?php if(!empty($republicans)) : ?>
                                            <div class="col-6">
                                                <h4 class="party-title republican">Republicans</h4>
                                                <ul class="list-group">
                                                    <?php foreach ($republicans as $c) : ?>
                                                        <li class="list-group-item REP<?php echo !empty($c['is_incumbent']) ? ' Incumbent' : ''; ?>">
                                                            <?php echo esc_html($c['name']); ?>
                                                        </li>
                                                    <?php endforeach; ?>
                                                </ul>
                                        ...
                                        <?php if(empty($democrats) && empty($republicans)) : ?>
                                            <ul class="list-group">
