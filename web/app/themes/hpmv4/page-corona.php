...
get_header(); ?>
	<style>
        ...
        .page-template-page-corona .link-thumb
        {
            display: flex;

        }
        .page-template-page-corona .link-thumb li
        {
            width: 100%;
        }
        .page-template-page-corona .highlights ul
        {
            margin:0;
            padding: 0;
        }
        .page-template-page-corona .news-links li
        {
