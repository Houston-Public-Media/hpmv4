			...
			<div class="houston-matters-page">
				...
				<div id="station-social" class="station-social">
					<div class="badges-box">
                        <p class="badge-title" style="padding-bottom: 10px;"><strong>Call us on <a style="color: #fff;" href="tel://+17134408870">713.440.8870</a> or Email Us on </strong><a style="color: #fff;" href="mailto:talk@hellohouston.org">talk@hellohouston.org</a></p>
...
<?php
						...
						if ( $cat->have_posts() ) {
							...
							if ( $cat->found_posts < 3 ) { ?>
									<?php if ( $cat->found_posts == 1 ) { ?><div class="col-sm-6 col-md-4"></div><?php } ?>
									<div class="col-sm-6 col-md-4">
										<div class="sidebar-ad">
											<h4>Support Comes From</h4>
											<div id="div-gpt-ad-1394579228932-1">
