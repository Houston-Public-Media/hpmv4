...
get_header(); ?>
    <style>
        ...
        .iframe-embed{width: 50% !important;}
        .iframe-embed-vert {
            position: relative;
                ...
                <div class="episodes-block">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-4">
                            <iframe width="100%" height="auto" src="https://www.youtube.com/embed/jVy6lSHgya4?si=PHC3Xn0JTrL7km2Z" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                        <div class="col-sm-6 col-md-4" style="padding-left: 20px;">
                            <iframe width="100%" height="auto" src="https://www.youtube.com/embed/77SnZgqy8Ow?si=FAnidP6QLZyW1KR8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </div>
                    </div>
                   <!-- <div class="row">
