...
if ( 0 < $days_to_rsvp ) {
	...
	$text = sprintf(
		...
		_x(
			'Last day to %s',
			'Last day to request a tour',
			'event-tickets'
		),
		tribe_get_rsvp_label_singular( 'Last day to request a tour' )
	);
}
?>
